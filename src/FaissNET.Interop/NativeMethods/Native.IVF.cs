...
internal static unsafe partial class Native
{
    ...
    [LibraryImport(LibraryName)]
    internal static partial void faiss_IndexIVF_invlists_get_ids(FaissIndexHandle index, nuint listNo, IntPtr invlist);
    ...
    [LibraryImport(LibraryName)]
    internal static partial int faiss_IndexIVFScalarQuantizer_new_with_metric(out IntPtr pIndex, FaissIndexHandle quantizer, nuint d, nuint nlist, QuantizerType qt, MetricType metric, [MarshalAs(UnmanagedType.Bool)] bool encodeResidual);
    
    [LibraryImport(LibraryName)]
    internal static partial nuint faiss_IndexIVFScalarQuantizer_nlist(FaissIndexHandle index);
    
    [LibraryImport(LibraryName)]
    internal static partial nuint faiss_IndexIVFScalarQuantizer_nprobe(FaissIndexHandle index);
    
    [LibraryImport(LibraryName)]
    internal static partial void faiss_IndexIVFScalarQuantizer_set_nprobe(FaissIndexHandle index, nuint nprobe);
    ...
    [LibraryImport(LibraryName)]
    internal static partial nuint faiss_IndexIVFFlat_nprobe(FaissIndexHandle index);

    [LibraryImport(LibraryName)]
    internal static partial void faiss_IndexIVFFlat_set_nprobe(FaissIndexHandle index, nuint nprobe);
