...
/// <inheritdoc/>
public class IndexHNSWFlat : IndexHNSW, IClonableFloatIndex<IndexHNSWFlat>, IFromNativeIndexHandle<IndexHNSWFlat>
{
    ...
    private static FaissIndexHandle CreateHandle(string description, int dimensions, MetricType metricType) => IndexFactory.Create<IndexHNSWFlat>(description, dimensions, metricType).NativeHandle;

    public override IndexHNSWFlat Clone() => ClonableFloatIndexImpl<IndexHNSWFlat>.Clone(this);
}