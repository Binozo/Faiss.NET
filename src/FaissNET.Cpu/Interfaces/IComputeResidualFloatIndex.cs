...
internal static class ComputeResidualFloatIndexImpl
{
    public static void ComputeResidual(INativeIndex index, ReadOnlySpan<float> originalVector, Span<float> residualVector, long key)
    {
        ...
        unsafe
        {
            ...
            {
                FaissErrorHandler.ThrowIfError(Native.faiss_Index_compute_residual(index.Handle, pX, pRes, key));
            }
        }
    }
    
    public static void ComputeResidual(INativeIndex index, ReadOnlySpan<float> originalVectors, Span<float> residualVectors, ReadOnlySpan<long> keys)
    {
        ...
        unsafe
        {
            ...
            {
                FaissErrorHandler.ThrowIfError(Native.faiss_Index_compute_residual_n(index.Handle, count, pX, pRes, pKeys));
            }
        }
    }
}