...
{
    public static void Write(INativeIndex index, string filePath)
    {
    ...
    public static void Write(INativeIndex index, Stream stream)
    {
        ...
        // Pin the delegate so the function pointer remains valid during native I/O
        ...
        try
        {
            ...
            {
                FaissErrorHandler.ThrowIfError(
                    Native.faiss_write_index_custom(index.Handle, ioWriter, 0)
                );
            }
            finally
            {
